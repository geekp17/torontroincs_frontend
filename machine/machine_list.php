  ...
  <body class="bg-light">
    ...
    <div class="container my-4">
      <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3">Machine List</h1>
        <a class="btn btn-success" href="./machine_form.php">New Machine</a>
      </div>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', () => {
              ...
              listEl.innerHTML = items.map(row => (
                ...
                `<td class="text-end">
                   <div class="btn-group btn-group-sm">
                     <a class="btn btn-outline-primary" href="./machine_detail.php?id=${row.id || row.pk}">View</a>
          ...
          document.getElementById('table').addEventListener('click', async (e) => {
            ...
            if (action === 'edit') {
              location.href = './machine_form.php?id=' + id;
            }
          });
