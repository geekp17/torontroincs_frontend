...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h1 class="h3">Part Number Detail</h1>
...
<div class="card shadow-sm">
  <div class="card-body">
    <div class="table-responsive">
      <table class="table">
        <tbody>
          <tr><th>Name</th><td id='f_name'></td></tr><tr><th>Details</th><td id='f_details'></td></tr><tr><th>Customer Part Number</th><td id='f_customer_part_number'></td></tr>
        </tbody>
      </table>
    </div>
  </div>
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    document.getElementById('f_details').textContent = (data['details']);
